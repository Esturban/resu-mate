...
export default function HeroLogos(): JSX.Element {
  ...
  return (
    <div className='relative xl:h-3/4'>
      <h2 className="absolute top-[-100px] left-1/2 transform -translate-x-1/2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mx-1 text-center py-10">Companies our clients work at:</h2>
      <div className='bottom-0 left-0 right-0 mx-auto flex justify-center pb-4 sm:pb-8 md:pb-12 lg:pb-16 xl:w-3/4 md:w-full'>   
