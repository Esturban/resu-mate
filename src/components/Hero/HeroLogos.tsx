...
export default function HeroLogos(): JSX.Element {
  ...
  return (
    <div className='relative'>
      <h2 className="absolute top-[-100px] left-1/2 transform -translate-x-1/2 sm:text-5xl xxs:text-4xl text-3xl font-bold mx-1 text-center">Companies our clients work at:</h2>
      <hr></hr>
      <div className='bottom-0 left-0 right-0 mx-auto flex justify-center pb-4 sm:pb-8 md:pb-12 lg:pb-16 w-3/4'>   
        <Marquee className="lg:rounded-full bg-gray-100 py-2 opacity-70 w-full bg-slate-200" gradient={false} loop={0} speed={100}>
